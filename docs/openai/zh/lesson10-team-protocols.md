...
mvn spring-boot:run -pl openai -Dspring-boot.run.arguments="--lesson=10 --prompt='Spawn a worker teammate. Send it a task, then request it to shut down gracefully.'"
```
